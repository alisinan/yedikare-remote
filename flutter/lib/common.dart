        ...
        if (key.logicalKey == LogicalKeyboardKey.escape) {
          ...
          return KeyEventResult.handled; // avoid TextField exception on escape
            ...
            (key.logicalKey == LogicalKeyboardKey.enter ||
                ...
                key.logicalKey == LogicalKeyboardKey.gameButtonA)) {
        ...
        Timer(Duration(seconds: 1), () async {
          ...
          final confirmed = await showDialog<bool>(
            ...
            builder: (context) => AlertDialog(
              ...
              content: Text(translate('A link is trying to change your permanent password. Allow this?')),
              actions: [
                TextButton(
...
Future<void> onActiveWindowChanged() async {
  ...
  if (rustDeskWinManager.getActiveWindows().isEmpty) {
    ...
    try {
      ...
      debugPrint("Start closing HopToDesk...");
...
const kMacOSPermChannel = MethodChannel("org.hoptodesk.hoptodesk/macos");
