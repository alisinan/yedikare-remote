...
const String kPeerPlatformAndroid = "Andr" + "oid"; //Fix for Apple store
...
const String kOptionAutoRotate = "auto-rotate";
...
const String kOptionCustomApiUrl = "custom-api-url";
